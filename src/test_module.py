...
class UnitTests(unittest.TestCase):
    ...
    def test_prob_experiment(self):
        ...
        probability = prob_calculator.experiment(hat=hat, balls_to_draw={"blue":2,"green":1}, num_balls_drawn=4, num_experiments=1000)
        actual = probability
        expected = 0.272
        ...
        probability = prob_calculator.experiment(hat=hat, balls_to_draw={"yellow":2,"blue":3,"test":1}, num_balls_drawn=20, num_experiments=100)
        actual = probability
        expected = 1.0
